...
#cd $(pwd)
cd /userhome/10ue_xjtu_code/all_loss_normal_transformer
start=$(date +%s)
echo "START: $(date)"
#data_path='/userhome/ChinaUnicom4G_code'
data_path=/userhome/10ue_xjtu_shieldingbox_ChinaMobileFDD_20220118
#augmentation_rate=32 # options: 1. 32, 2. 152 3. 272
exp_name="source_normal_transformer_abs_center_loss_test"
GPU_NUM=2
