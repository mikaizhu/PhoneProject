...
parser.add_argument('--augmentation_rate', type=int, default=128)
...
args.embed_dim = args.window_len / 2 / 60
...
model = TransfromerModel(L1=args.window_len, num_class=phone_data.num_class, d_model=60, n_head=6, dropout=0.2).to(device)
...
optimizer_cent = optim.AdamW(criterion_cent.parameters(), lr=0.0001) # lr center loss learning rate
